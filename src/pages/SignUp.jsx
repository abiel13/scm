...
<p className="absolute text-center font-medium text-xl text-white w-3/4 left-1/2 -translate-x-1/2 bottom-0 ">Sign Up For SMP Today</p>
      </div>
      ...
      <div className="w-3/4 md:w-1/2 flex flex-col items-center lg:w-2/5 lg:shadow-lg  lg:absolute lg:left-3/4 lg:-translate-x-3/4 lg:h-3/4 lg:text-center lg:px-5">
